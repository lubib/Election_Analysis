...
with open(file_to_save, "w") as txt_file:
    ...
    for county in counties_dict:
        ...
        county_total_votes =  counties_dict.get(county)
        # 6c: Calculate the percent of total votes for the county.
        county_vote_percentage = float(county_total_votes) / float(total_votes) *100

         # 6d: Print the county results to the terminal.
        county_results=(f" {county_name}: {county_vote_percentage} ({county_total_votes:,})/n")
    ...
    winning_candidate_summary = (
        ...
        f"The county with the largest turnout\n")
